...
namespace Omni.Execution
{
    internal static class QueryExtensions
    {
        ...
        {
            return await CreateQueryFactory(query)
                .ExistsAsync(query, transaction, timeout, cancellationToken);
        }

        internal static bool NotExist(
            this Query query,
            IDbTransaction transaction = null,
            int? timeout = null
        )
        ...
        internal static async Task<bool> NotExistAsync(
            this Query query,
            IDbTransaction transaction = null,
            int? timeout = null,
            CancellationToken cancellationToken = default
        ...
        {
            return !(
                await CreateQueryFactory(query)
                    .ExistsAsync(query, transaction, timeout, cancellationToken)
            );
        }

        internal static IEnumerable<T> Get<T>(
            this Query query,
            IDbTransaction transaction = null,
            int? timeout = null
        )
        ...
        internal static async Task<IEnumerable<T>> GetAsync<T>(
            this Query query,
            IDbTransaction transaction = null,
            int? timeout = null,
            CancellationToken cancellationToken = default
        ...
        {
            return await CreateQueryFactory(query)
                .GetAsync<T>(query, transaction, timeout, cancellationToken);
        }

        internal static IEnumerable<dynamic> Get(
            this Query query,
            IDbTransaction transaction = null,
            int? timeout = null
        )
        ...
        internal static async Task<IEnumerable<dynamic>> GetAsync(
            this Query query,
            IDbTransaction transaction = null,
            int? timeout = null,
            CancellationToken cancellationToken = default
        ...
        internal static async Task<T> FirstOrDefaultAsync<T>(
            this Query query,
            IDbTransaction transaction = null,
            int? timeout = null,
            CancellationToken cancellationToken = default
        ...
        {
            return await CreateQueryFactory(query)
                .FirstOrDefaultAsync<T>(query, transaction, timeout, cancellationToken);
        }

        internal static dynamic FirstOrDefault(
            this Query query,
            IDbTransaction transaction = null,
            int? timeout = null
        )
        ...
        internal static async Task<dynamic> FirstOrDefaultAsync(
            this Query query,
            IDbTransaction transaction = null,
            int? timeout = null,
            CancellationToken cancellationToken = default
        ...
        internal static async Task<T> FirstAsync<T>(
            this Query query,
            IDbTransaction transaction = null,
            int? timeout = null,
            CancellationToken cancellationToken = default
        ...
        {
            return await CreateQueryFactory(query)
                .FirstAsync<T>(query, transaction, timeout, cancellationToken);
        }

        internal static dynamic First(
            this Query query,
            IDbTransaction transaction = null,
            int? timeout = null
        )
        ...
        internal static async Task<dynamic> FirstAsync(
            this Query query,
            IDbTransaction transaction = null,
            int? timeout = null,
            CancellationToken cancellationToken = default
        ...
        internal static PaginationResult<T> Paginate<T>(
            this Query query,
            int page,
            int perPage = 25,
            IDbTransaction transaction = null,
        ...
        internal static async Task<PaginationResult<T>> PaginateAsync<T>(
            this Query query,
            int page,
            int perPage = 25,
            IDbTransaction transaction = null,
        ...
        )
        {
            ...
            return await db.PaginateAsync<T>(
                query,
                page,
                perPage,
                transaction,
        ...
        internal static PaginationResult<dynamic> Paginate(
            this Query query,
            int page,
            int perPage = 25,
            IDbTransaction transaction = null,
        ...
        internal static async Task<PaginationResult<dynamic>> PaginateAsync(
            this Query query,
            int page,
            int perPage = 25,
            IDbTransaction transaction = null,
        ...
        {
            return await PaginateAsync<dynamic>(
                query,
                page,
                perPage,
                transaction,
        ...
        internal static async Task ChunkAsync<T>(
            this Query query,
            int chunkSize,
            Func<IEnumerable<T>, int, bool> func,
            IDbTransaction transaction = null,
        ...
        {
            await CreateQueryFactory(query)
                .ChunkAsync<T>(query, chunkSize, func, transaction, timeout, cancellationToken);
        }

        internal static void Chunk(
            this Query query,
            int chunkSize,
            Func<IEnumerable<dynamic>, int, bool> func,
            IDbTransaction transaction = null,
            int? timeout = null
        )
        {
        ...
        internal static async Task ChunkAsync(
            this Query query,
            int chunkSize,
            Func<IEnumerable<dynamic>, int, bool> func,
            IDbTransaction transaction = null,
        ...
        {
            await CreateQueryFactory(query)
                .ChunkAsync<T>(query, chunkSize, action, transaction, timeout, cancellationToken);
        }

        internal static void Chunk(
            this Query query,
            int chunkSize,
            Action<IEnumerable<dynamic>, int> action,
            IDbTransaction transaction = null,
            int? timeout = null
        )
        {
        ...
        {
            return await CreateQueryFactory(query)
                .ExecuteAsync(query.AsInsert(values), transaction, timeout, cancellationToken);
        }
        ...
        {
            return CreateQueryFactory(query)
                .Execute(query.AsInsert(columns, valuesCollection), transaction, timeout);
        }
        ...
        )
        {
            return await CreateQueryFactory(query)
                .ExecuteAsync(
                    query.AsInsert(columns, valuesCollection),
                    transaction,
                    timeout,
                    cancellationToken
                );
        ...
        {
            return CreateQueryFactory(query)
                .Execute(query.AsInsert(columns, fromQuery), transaction, timeout);
        }
        ...
        )
        {
            return await CreateQueryFactory(query)
                .ExecuteAsync(
                    query.AsInsert(columns, fromQuery),
                    transaction,
                    timeout,
                    cancellationToken
                );
        ...
        {
            return await CreateQueryFactory(query)
                .ExecuteAsync(query.AsInsert(data), transaction, timeout, cancellationToken);
        }

        internal static T InsertGetId<T>(
            this Query query,
            object data,
            IDbTransaction transaction = null,
            int? timeout = null
        ...
        internal static async Task<T> InsertGetIdAsync<T>(
            this Query query,
            object data,
            IDbTransaction transaction = null,
            int? timeout = null,
        ...
        {
            var row = CreateQueryFactory(query)
                .First<InsertGetIdRow<T>>(query.AsInsert(data, true), transaction, timeout);
        ...
        {
            return await CreateQueryFactory(query)
                .ExecuteAsync(query.AsUpdate(values), transaction, timeout, cancellationToken);
        }
        ...
        {
            return await CreateQueryFactory(query)
                .ExecuteAsync(query.AsUpdate(data), transaction, timeout, cancellationToken);
        }
        ...
        {
            return CreateQueryFactory(query)
                .Execute(query.AsIncrement(column, value), transaction, timeout);
        }

        internal static async Task<int> IncrementAsync(
            this Query query,
            string column,
            int value = 1,
            IDbTransaction transaction = null,
        ...
        )
        {
            return await CreateQueryFactory(query)
                .ExecuteAsync(
                    query.AsIncrement(column, value),
                    transaction,
                    timeout,
                    cancellationToken
                );
        ...
        {
            return CreateQueryFactory(query)
                .Execute(query.AsDecrement(column, value), transaction, timeout);
        }

        internal static async Task<int> DecrementAsync(
            this Query query,
            string column,
            int value = 1,
            IDbTransaction transaction = null,
        ...
        )
        {
            return await CreateQueryFactory(query)
                .ExecuteAsync(
                    query.AsDecrement(column, value),
                    transaction,
                    timeout,
                    cancellationToken
                );
        ...
        internal static async Task<int> DeleteAsync(
            this Query query,
            IDbTransaction transaction = null,
            int? timeout = null,
            CancellationToken cancellationToken = default
        ...
        {
            return await CreateQueryFactory(query)
                .ExecuteAsync(query.AsDelete(), transaction, timeout, cancellationToken);
        }

        internal static T Aggregate<T>(
            this Query query,
        ...
        internal static async Task<T> AggregateAsync<T>(
            this Query query,
            string aggregateOperation,
            string[] columns,
            IDbTransaction transaction = null,
        ...
        internal static async Task<T> CountAsync<T>(
            this Query query,
            string[] columns = null,
            IDbTransaction transaction = null,
            int? timeout = null,
        ...
        internal static async Task<T> AverageAsync<T>(
            this Query query,
            string column,
            IDbTransaction transaction = null,
            int? timeout = null,
        ...
        {
            return await query.AggregateAsync<T>(
                "avg",
                new[] { column },
                transaction,
                timeout,
        ...
        internal static async Task<T> SumAsync<T>(
            this Query query,
            string column,
            IDbTransaction transaction = null,
            int? timeout = null,
        ...
        internal static async Task<T> MinAsync<T>(
            this Query query,
            string column,
            IDbTransaction transaction = null,
            int? timeout = null,
        ...
        internal static async Task<T> MaxAsync<T>(
            this Query query,
            string column,
            IDbTransaction transaction = null,
            int? timeout = null,
        ...
        internal static QueryFactory CreateQueryFactory(XQuery xQuery)
        {
            ...
            if (xQuery.QueryFactory != null)
            {
                factory = new QueryFactory(
                    xQuery.Connection,
                    xQuery.Compiler,
                    xQuery.QueryFactory.QueryTimeout
                );
            }
            else
            {
