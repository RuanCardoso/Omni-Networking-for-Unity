...
// https://github.com/Unity-Technologies/com.unity.netcode.gameobjects/blob/develop/com.unity.netcode.gameobjects/Components/QuaternionCompressor.cs
namespace Omni.Core
{
    /// <summary>
    ...
    public static class QuaternionCompressor
    {
        ...
        private const float k_CompressionEcodingMask =
        ...
        private const float k_DcompressionDecodingMask =
            1.0f / k_PrecisionMask * k_SqrtTwoOverTwoEncoding;
        ...
        public static uint Compress(Quaternion quaternion)
        {
            ...
            var indexToSkip = (ushort)(
                s_QuatAbsValues[0] == quatMax
                    ? 0
                    : s_QuatAbsValues[1] == quatMax
                        ? 1
                        : s_QuatAbsValues[2] == quatMax
                            ? 2
                            : 3
            );
        ...
        public static Quaternion Decompress(uint compressed)
        {
            ...
            for (int i = 3; i >= 0; --i)
            {
                ...
                quaternion[i] =
                    ...
                    * ((compressed & k_PrecisionMask) * k_DcompressionDecodingMask);
