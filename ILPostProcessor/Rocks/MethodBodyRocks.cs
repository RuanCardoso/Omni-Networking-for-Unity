...
namespace Mono.CecilX.Rocks
{
    ...
    {
        internal static ParameterDefinition GetParameter(this MethodBody self, int index)
        {
        ...
        internal static void SimplifyMacros(this MethodBody self)
        {
            if (self == null)
        ...
        internal static void Optimize(this MethodBody self)
        {
            if (self == null)
                throw new ArgumentNullException("self");
        ...
        internal static void OptimizeMacros(this MethodBody self)
        {
            if (self == null)
                throw new ArgumentNullException("self");
