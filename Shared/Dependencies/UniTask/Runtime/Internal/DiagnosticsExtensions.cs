...
namespace Omni.Threading.Tasks.Internal
{
    internal static class DiagnosticsExtensions
    {
        ...
        static string BeautifyType(Type t, bool shortName)
        {
            ...
            if (!t.IsGenericType) return shortName ? t.Name : t.FullName.Replace("Omni.Threading.Tasks.Triggers.", "").Replace("Omni.Threading.Tasks.Internal.", "").Replace("Omni.Threading.Tasks.", "") ?? t.Name;
            ...
            return typeBeautifyRegex.Replace(genericType, "").Replace("Omni.Threading.Tasks.Triggers.", "").Replace("Omni.Threading.Tasks.Internal.", "").Replace("Omni.Threading.Tasks.", "") + "<" + innerFormat + ">";
        }
        ...
        static bool IgnoreLine(MethodBase methodInfo)
        {
            ...
            else if (declareType.StartsWith("Omni.Threading.Tasks.CompilerServices"))
            {
                return true;
            }
            ...
            else if (declareType.StartsWith("Omni.Threading.Tasks.UniTaskCompletionSourceCore"))
            {
                return true;
            }
            else if (declareType.StartsWith("Omni.Threading.Tasks.AwaiterActions"))
            {
                return true;
            }
